...
pic1.addEventListener("click" , ()=>{
    pic1.src = "/git-github-demo/bff-1.jpeg"
})
pic2.addEventListener("click" , ()=>{
    pic2.src = "/git-github-demo/bff-2.jpeg"
})
pic3.addEventListener("click" , ()=>{
    pic3.src = "/git-github-demo/WhatsApp Image 2026-09-19 at 10.09.30 PM.jpeg"
})
pic4.addEventListener("click" , ()=>{
    pic4.src = "/git-github-demo/bff-4.jpeg"
})